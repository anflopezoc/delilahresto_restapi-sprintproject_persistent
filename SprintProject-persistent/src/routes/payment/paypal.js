...
router.post('/pago', async (req, res) => {
    ...
    request.requestBody({
          ...
          "application_context": {
            "return_url": `http://localhost:${process.env.BACKPORT}/paypal/redirect`, //se define la url de regreso si se completó el pago -> 3.
            "cancel_url": `http://localhost:${process.env.BACKPORT}/paypal/cancel` //se define la url de regreso si se quiere cancelar -> 4.
          }
    });
    client
        .execute(request)
